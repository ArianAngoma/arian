            ...
            <div className="hero">
                <div className="container">
                    <h1 className="hero__heading">
                        <span>Hola, soy</span>
                        <span className="hero__name">Arian Angoma</span>
                    </h1>
                    ...
                    <div className="hero__social">
                        ...
                        <div className="hero__social__text">
                            <ul>
                                ...
                                <li>
                                    <a
                                        href="https://twitter.com/ArianAngomaJS"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        TW
                                ...
                                {/*<li>
                                    <a
                                        href="https://www.instagram.com/papafritaconcremas/"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        IG
                                ...
                                <li>
                                    <a
                                        href="https://www.facebook.com/arian.angomavilchez.9/"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                                        FB
